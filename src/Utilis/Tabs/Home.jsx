...
const Home = () => {
  return (
    <div className="min-h-full bg-gradient-to-b from-yellow-100 to-red-100 flex flex-col">
      <div className="flex flex-col lg:flex-row items-center justify-center px-4 py-10 gap-10 md:px-8 flex-grow">
        ...
        <div className="w-full lg:w-1/2 flex items-center justify-center">
          ...
          >
            ...
            >
              ...
              Burger, we don't just serve food — we stack flavor, fun, and
              full-on beast mode in every bite. Big burgers. Bigger vibes.
              Beast-worthy satisfaction.
            </motion.p>
          </motion.div>
        </div>
      </div>
